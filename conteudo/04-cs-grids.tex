...
\begin{equation}
	\label{mt-sina}
	\sqrt{\mathfrak{g}}(x,y) =	
\|\partial_x  \boldsymbol{\Phi}_p \| \|\partial_y  \boldsymbol{\Phi}_p \| \sin \alpha(x,y,p),
\end{equation}
where $\alpha$ is the angle between $\partial_x \boldsymbol{\Phi}_p$ and $\partial_y \boldsymbol{\Phi}_p$ that
satisfies
\begin{equation*}
	\label{mt-cosa}
\cos{\alpha(x,y,p)} = \frac{\langle  {\partial_x  \boldsymbol{\Phi}_p}, {\partial_x \boldsymbol{\Phi}_p} \rangle }
{\|\partial_x \boldsymbol{\Phi}_p\|  \|\partial_y \boldsymbol{\Phi}_p\|}.
\end{equation*}
