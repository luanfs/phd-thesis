...
Through simulations, we demonstrate that the current FV3 advection scheme is only first-order accurate for divergent winds, while our scheme is second-order accurate.
...
However, we demonstrate through numerical simulations that the proposed advection scheme exhibits slightly reduced sensitivity to the cube corners.
}
