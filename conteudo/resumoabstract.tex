\palavrachave{Núcleo dinâmico da atmosfera, esfera cubada, volumes finitos, dimension splitting, ponto de partida, corretor de massa, advecção, água rasa}
...
Desde então, o FV3 tornou-se popular para modelagem atmosférica global e serve como núcleo dinâmico para muitos modelos.
...
modificar a forma como o termo métrico da esfera cubica é tratado ao calcular os fluxos 1D.
