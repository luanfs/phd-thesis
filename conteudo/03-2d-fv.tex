...
\begin{prob}
   ...
   ${q}(x, c, t) = {q}(x, d, t), \quad \forall x \in [a,b],  \quad \forall t\geq 0.$
\end{prob}
Similarly to Section \ref{chp-adv1d-sec1}, Equation \eqref{sec-adv2d:eq1} and Problem \eqref{chp3-sec2-prob1} are equivalent
...
The Lie splitting is obtained by solving the advection in the $x$ direction
\begin{align*}
...
\begin{align*}
	{Q}^{xy,n} = Q^{y,n} + \mathbf{F}[Q^{y,n},\tilde{c}^{x,n}],
\end{align*}
...
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc1_N48_hord0_iadv1_dp1_t0}
%		\caption{IC\label{chp-adv2d-sec-exp-adv1-a}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc1_N48_hord0_iadv1_dp1_t13}
%		\caption{$t=2$ days.\label{chp-adv2d-sec-exp-adv1-b}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc1_N48_hord8_iadv1_dp1_t13}
%		\caption{$t=4$ days.\label{chp-adv2d-sec-exp-adv1-c}}
%	\end{subfigure}
	
%	\caption{ok \label{chp-adv2d-sec-exp-adv1}}
%\end{figure}

%\begin{figure}[!htb]
%	\centering
%	\includegraphics[width=0.3\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t0}
...
%		\caption{$t=0$.\label{chp-adv2d-sec-exp-adv3-a}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t4}
%		\caption{$t=2$ days.\label{chp-adv2d-sec-exp-adv3-b}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t6}
%		\caption{$t=4$ days.\label{chp-adv2d-sec-exp-adv3-c}}
%	\end{subfigure}
	
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t8}
%		\caption{$t=6$ days.\label{chp-adv2d-sec-exp-adv3-d}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t10}
%		\caption{$t=8$ days.\label{chp-adv2d-sec-exp-adv3-e}}
%	\end{subfigure}
%	\begin{subfigure}{0.3\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t12}
%		\caption{$t=10$ days.\label{chp-adv2d-sec-exp-adv3-f}}
%	\end{subfigure}
%	\caption{Linear advection experiment using the velocity from Equation \eqref{chp-adv1d-ic2},
%		a CFL number equal to $0.92$, $N=M=768$, and the initial condition is given by 
%		Equation \eqref{chp-adv1d-ic2} \eqref{chp-adv1d-sec-exp-adv2-a}.
%		These figures show the advected profile at
%		2 \eqref{chp-adv2d-sec-exp-adv3-a}, 
%		4  \eqref{chp-adv2d-sec-exp-adv3-b},
%		6  \eqref{chp-adv2d-sec-exp-adv3-c},
%		8  \eqref{chp-adv2d-sec-exp-adv3-d},
%		10  \eqref{chp-adv2d-sec-exp-adv3-e},
%		and 12  \eqref{chp-adv2d-sec-exp-adv3-f} days.
%		We are using the hord8 scheme with the DP1 departure point scheme. \label{chp-adv2d-sec-exp-adv3}}
%\end{figure}
