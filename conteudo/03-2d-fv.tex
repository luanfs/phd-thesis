...
For the 1D schemes, we will consider the FV-SL unlimited PPM ({hord0}, Subsection \ref{chp-adv1d-sec-hord0}) and the limited PPM
({hord8}, Subsection \ref{chp-adv1d-sec-hord8}), 
...
\begin{figure}[!htb]
	...
	We run this test with the PL splitting combined with the unlimited PPM hord0 (b) and the limited PPM hord8 (c).
...
Schemes using the unlimited PPM (hord0) are on the left, and the limited PPM (hord8) are on the right.
