...
\section{Two-dimensional advection equation in the integral form}
\label{sec-adv2d}
\subsection{Notation}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t2}
		\caption{$t=2$ days.\label{chp-adv2d-sec-exp-adv2-a}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t4}
		\caption{$t=4$ days.\label{chp-adv2d-sec-exp-adv2-b}}
	\end{subfigure}

	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t6}
		\caption{$t=6$ days.\label{chp-adv2d-sec-exp-adv2-c}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t8}
		\caption{$t=8$ days.\label{chp-adv2d-sec-exp-adv2-d}}
	\end{subfigure}

	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t10}
		\caption{$t=10$ days.\label{chp-adv2d-sec-exp-adv2-e}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t12}
	...
	\caption{Linear advection experiment using the velocity from Equation \eqref{chp-adv2d-vf1},
        ...
        {The white arrows illustrate the velocity field}.
...
We can observe from Figure \ref{chp-adv2d-sec-exp-adv2-error-linf} that for the unlimited PPM, PL-DP1 and LT-DP2 have smaller
...
{The results of the monotonic scheme have an order of approximately 1.5, which is expected, as the monotonic limiter reduces the order of accuracy.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t2}
		\caption{$t=2$ days.\label{chp-adv2d-sec-exp-adv3-a}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t4}
		\caption{$t=4$ days.\label{chp-adv2d-sec-exp-adv3-b}}
	\end{subfigure}

	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t6}
		\caption{$t=6$ days.\label{chp-adv2d-sec-exp-adv3-c}}
	\end{subfigure}	
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t8}
		\caption{$t=8$ days.\label{chp-adv2d-sec-exp-adv3-d}}
	\end{subfigure}

	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t10}
		\caption{$t=10$ days.\label{chp-adv2d-sec-exp-adv3-e}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1.25\linewidth]{adv2d_tc4_N768_hord8_iadv1_dp1_t12}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\linewidth]{adv2d_tc4_linf_error}
	\caption{$L_{\infty}$ error for the two Gaussian hills (Equation \ref{chp-adv2d-ic2})
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\linewidth]{adv2d_tc4_l1_error}
