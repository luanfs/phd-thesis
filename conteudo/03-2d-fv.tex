...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.4\linewidth]{adv2d_tc3_N768_hord8_iadv1_dp1_t0}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.7\linewidth]{adv2d_tc3_linf_error}
\caption{$L_{\infty}$ error.\label{chp-adv2d-sec-exp-adv2-error-linf}}
\end{figure}

\begin{figure}[!htb]
\centering
\includegraphics[width=0.7\linewidth]{adv2d_tc3_l1_error}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.7\linewidth]{adv2d_tc4_linf_error}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.7\linewidth]{adv2d_tc4_l1_error}
