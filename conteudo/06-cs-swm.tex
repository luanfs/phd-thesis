...
\begin{align*}
	...
	\bigg].
\end{align*}
This is straightforward from the definition of divergence in terms of cubed-sphere mapping (Equation \eqref{advcs:eqdiv}).
...
We may apply this procedure as many times as we want.
This process results in divergence damping (dd) which is a explicit dissipation mechanism.
Dissipation mechanisms are commonly used in dynamical cores to ensure numerical stability and avoid accumulation of energy at small scales.
There are many other ways of introducing dissipation besides divergence damping (see \citet{jablonowski:2011} for a review)
For an comprehensive analysis of the divergence damping, refer to \citet{whitehead:2011}. 
