...
These schemes shall be tested with the limited PPM scheme (hord8).
...
\begin{figure}[!h]
	...
	\end{subfigure}
	\caption{
		Geostrophic balanced flow test error distribution using the limited PPM (hord8)
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\linewidth]{u_linferror_tc2_alpha45}
...
\begin{figure}[!htb]
	...
	\caption{
		...
		Blue lines indicate the use of the LT scheme, while green lines represent the PL scheme. All schemes use the limited PPM (hord8).
