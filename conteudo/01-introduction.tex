...
\textcolor{red}{The Global Forecast System (GFS) from the National Centers for Environmental Prediction (NCEP) 
...
\textcolor{red}{It was chosen as the new US GFS dynamical core, indeed replacing the spectral transform GFS in 2019, as mentioned before.}
...
\textcolor{red}{requiring minor extra computational cost and only minor modifications to the current FV3 code}
