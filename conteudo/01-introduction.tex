...
The FV3 dynamical core is also employed in the GEOS Chem model \citep{martin:2022} from Harvard University,
aimed at aerosols,
in NASA’s next-generation Mars Climate Model \citep{wilson:2022},
and also the model SHiELD from GFDL \citep{harris:2020}.
