...
\newpage
This indicates that LT is less sensitive to corners than PL when using MONO. 
...
For MONO (dashed lines), we can see that the $L_{\infty}$ errors for LT (blue lines) are smaller than the errors of PL (green lines), especially for the equi-edge grid (g0).
...
Furthermore, LT and PL demonstrate the same errors when utilizing MONO.%, reaffirming that LT is indeed more accurate than PL.
