...
where the PPM perturbation values $b^L$ and $b^R$ values are computed using the unlimited PPM hord0 (Section \ref{chp-adv1d-sec-hord0}) or the limited PPM (hord8) (Section \ref{chp-adv1d-sec-hord8})
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{h_tc1_t0_alpha45_C192_g2_dg2_adv2_hord8_mf1_tf12}
		\caption{IC2. \label{chp5-ic2}}
	\end{subfigure}

	\begin{subfigure}{0.45\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{h_tc-7_t0_alpha45_C192_g2_dg2_adv2_hord8_mf1_tf12}
...
These schemes will be tested using the unlimited PPM (hord0) and the limited PPM (hord8) 1D PPM schemes.
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Advection experiment  results using IC1 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}).
		...
		We are using the LT-hord8-mf1 scheme on the equiangular grid (g2) with $N=384$. \label{chp-advcs-sec-exp-adv2}}
\end{figure}
...
Dashed lines represent the limited PPM (hord8) while solid lines represent the unlimited PPM (hord0).
...
Another conclusion is that the mass fixer does not have too much impact on error evolution when the limited PPM (hord8) scheme is used.
However, from Figure \ref{chp-advcs-sec-exp-adv2-evol-linf} we can see some small spikes in the $L_{\infty}$ error
on the equi-edge grid (g0) when using the PL scheme, which is not very pronounced in the LT scheme.
\begin{figure}[!htb]
	\centering
	...
	\caption{
		...
		Solid lines represent the results with the unlimited PPM (hord0) scheme, whereas dashed lines represent the results with the limited PPM (hord8).
...
Also, the equi-edge grid (g0) and  the equiangular grid (g2) yield similar results for both schemes, 
although the equiangular grid (g2) exhibits a very small error near the corner, which is not observed in the equi-edge grid (g0), 
indicating that the equi-edge grid (g0) is less sensitive to the corner for the LT scheme.
\begin{figure}[!htb]
	\centering
	\begin{subfigure}{0.45\textwidth}
		\centering
	...
	\end{subfigure}
	\caption{
		Advection experiment errors at a cube corner using IC1 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}) after 12 days, using hord8
...
We can observe that all schemes with the unlimited PPM (hord0) achieve second-order accuracy as expected.
...
for both $L_{\infty}$ and $L_{2}$ norms on both equi-edge grid (g0) and the equiangular grid (g2), indicating that LT is more accurate.
...
\begin{figure}[!htb]
	...
	\caption{
$L_{\infty}$ error convergence for IC1 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}) on the equi-edge grid (g0, left) 
and on the equiangular grid (g2, right) grids after 12 days.
Blue lines indicate the use of the LT scheme, while green lines represent the PL scheme.
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.35\textwidth}
		...
		\caption{PL scheme.\label{chp-advcs-sec-exp-adv5-errors-0a}}
	\end{subfigure}
	\begin{subfigure}{0.35\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{h_error_tc1_t12_alpha45_C384_g0_dg2_adv2_hord8_mf1_tf12}
		\caption{LT scheme.\label{chp-advcs-sec-exp-adv5-errors-0b}}
	\end{subfigure}
	\caption{
		Advection experiment errors at a cube corner using IC2 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}) after 12 days, using hord8
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.35\textwidth}
		...
		\caption{PL scheme.\label{chp-advcs-sec-exp-adv5-errors-2a}}
	\end{subfigure}
	\begin{subfigure}{0.35\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{h_error_tc1_t12_alpha45_C384_g2_dg2_adv2_hord8_mf1_tf12}
		\caption{LT scheme.\label{chp-advcs-sec-exp-adv5-errors-2b}}
	\end{subfigure}
...
for the unlimited PPM (hord0) (solid lines) are not achieving second order as they should because the solution is not differentiable.
For hord8 (dashed lines), we can see that the $L_{\infty}$ errors for LT (blue lines) are smaller than the errors of PL (green lines), especially for the equi-edge grid (g0).
Also, for the equi-edge grid (g0), the order of the LT-hord8 scheme in the $L_{\infty}$ norm gets very close to 2,
and for the equiangular grid (g2), its order surpasses two.
These results for LT-hord8 are better than expected and are not observed for the PL-hord8 scheme.
Finally, the $L_2$ errors are very similar (Figure \ref{chp-advcs-sec-exp-adv5-l2}).
\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\linewidth]{linferror_tc1_alpha45}
	\caption{As Figure \ref{chp-advcs-sec-exp-adv2-linf} but using IC2 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}).\label{chp-advcs-sec-exp-adv5-linf}}
\end{figure}

\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\linewidth]{l2error_tc1_alpha45}
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Similar to Figure \ref{chp-advcs-sec-exp-adv2} but using IC3 (Table \ref{chp5-ic})
	and VF1 (Table \ref{chp5-vf}) with $N=192$. \label{chp-advcs-sec-exp-adv6}}
\end{figure}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\caption{PL-hord8 at the equi-edge grid (g0).\label{chp-advcs-sec-exp-adv7-b}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{h_tc-7_t12_alpha45_C192_g0_dg2_adv2_hord8_mf1_tf12}
		\caption{LT-hord8 at the equi-edge grid (g0).\label{chp-advcs-sec-exp-adv7-c}}
	\end{subfigure}
	
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{h_tc-7_t12_alpha45_C192_g2_dg2_adv1_hord8_mf1_tf12}
		\caption{PL-hord8 at the equiangular grid (g2).\label{chp-advcs-sec-exp-adv7-d}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{h_tc-7_t12_alpha45_C192_g2_dg2_adv2_hord8_mf1_tf12a}
	\caption{PL-hord8 at the equiangular grid (g2).\label{chp-advcs-sec-exp-adv7-e}}
    \end{subfigure}
	...
	PL-hord8 at the equi-edge grid (g0) (a),	LT-hord8 at the equi-edge grid (g0) (b), 
	PL-hord8 at the equiangular grid (g2) (c) and LT-hord8 at the equiangular grid (g2) (d).
	(e) depicts the reference solution.
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Similar to Figure \ref{chp-advcs-sec-exp-adv2} but using IC4 (Table \ref{chp5-ic}) and VF2 (Table \ref{chp5-vf}).\label{chp-advcs-sec-exp-adv3}}
\end{figure}
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{
		Advection experiment errors using IC4 (Table \ref{chp5-ic}) and VF2 (Table \ref{chp5-vf}) after 12 days, using hord8
		with PL (left) and LT schemes (right) on the equi-edge grid (g0) with $N=384$. 
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{As Figure \ref{chp-advcs-sec-exp-adv3-errors-0} but using the the equiangular grid (g2).\label{chp-advcs-sec-exp-adv3-errors-2}}
\end{figure}
...
Once more, it is evident that all schemes with the unlimited PPM (hord0) achieve second-order accuracy as expected, while those with hord8 experience a reduced order 
...
\begin{figure}[!htb]
	...
	\caption{As Figure \ref{chp-advcs-sec-exp-adv2-linf} but using  IC4 (Table \ref{chp5-ic}) and VF2 (Table \ref{chp5-vf}).\label{chp-advcs-sec-exp-adv3-linf}}
\end{figure}
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Similar to Figure \ref{chp-advcs-sec-exp-adv2} but using IC4 (Table \ref{chp5-ic}) and VF3 (Table \ref{chp5-vf}).\label{chp-advcs-sec-exp-adv4}}
\end{figure}
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{
	 Advection experiment errors using IC4 and VF3 from Table \ref{chp5-ic} after 12 days, using hord8
	 with PL (left) and LT schemes (right) on the equi-edge grid (g0) with $N=384$.
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{As Figure \ref{chp-advcs-sec-exp-adv4-errors-0} but using the the equiangular grid (g2).\label{chp-advcs-sec-exp-adv4-errors-2}}
\end{figure}
...
It is clear that PL with the unlimited PPM (hord0) achieves only first-order accuracy, whereas LT with the unlimited PPM (hord0) achieves third-order accuracy, 
surpassing second-order the expectation, for both equi-edge grid (g0) and the equiangular grid (g2) and norms.
For the limited PPM (hord8), LT demonstrates second-order accuracy in the $L_2$ norm, while PL is only first-order.
LT with the limited PPM (hord8) exhibits smaller errors in the $L_{\infty}$ norm compared to the PL scheme for all grids.
...
\begin{figure}[!htb]
	...
	\caption{As Figure \ref{chp-advcs-sec-exp-adv2-linf} but using  IC4 (Table \ref{chp5-ic}) and VF3 (Table \ref{chp5-vf}).\label{chp-advcs-sec-exp-adv4-linf}}
\end{figure}
...
that some errors of PL presented small spikes whenever the Gaussian hill passed over a corner,
while LT did not exhibit this behavior.
Also, the final error of PL was concentrated at a cube corner, which was not observed for the LT scheme.
The overall results for these test showed that the LT scheme have smaller errors in general.
