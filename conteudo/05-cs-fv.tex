...
\begin{figure}[!htb]
	...
	\caption{
		$L_{\infty}$ error evolution for IC1 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}) on the g0 (left) and g2 (right) grids for 12 days and $N=384$.
...
\begin{figure}[!htb]
	...
	\caption{
$L_{\infty}$ error convergence for IC1 (Table \ref{chp5-ic}) and VF1 (Table \ref{chp5-vf}) on the g0 (left) and g2 (right) grids after 12 days.
Blue lines indicate the use of the LT scheme, while green lines represent the PL scheme.
Solid lines represent the results with the hord8 scheme, whereas dashed lines represent the results with hord8.
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{As Figure \ref{chp-advcs-sec-exp-adv2-errors-0} but using the g2 grid.\label{chp-advcs-sec-exp-adv5-errors-2}}
\end{figure}

In Figure \ref{chp-advcs-sec-exp-adv5-errors-0}, we show the final error at the cube corner for the grid g0, 
and Figure \ref{chp-advcs-sec-exp-adv5-errors-2} show the same for the grid g0.
...
We conclude again that LT has a smaller error at the corner, especially for the g0 grid.
\newpage
...
for hord0 (solid lines) are not achieving second order as they should because the solution is not differentiable.
For hord8 (dashed lines), we can see that the $L_{\infty}$ errors for LT (blue lines) are smaller than the errors of PL (green lines), especially for the g0 grid.
Also, for g0, the order of the LT-hord8 scheme in the $L_{\infty}$ norm gets very close to 2, and for the grid g2, its order surpasses two.
...
\begin{figure}[!htb]
	...
	PL-hord8 at g0 a(a),	LT-hord8 at g0 (b), PL-hord8 at g2 (c) and LT-hord8 at g2 (d).
