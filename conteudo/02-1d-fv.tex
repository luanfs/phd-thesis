...
\begin{figure}[!htb]
	...
	\caption{
		\textcolor{red}{
		Illustration of the scheme DP1 for computing the departure point at time level $n$ emanating from $x_{i+\frac{1}{2}}$ (blue square) at time level $n+1$, assuming $u^{n+\frac{1}{2}}_{i+\frac{1}{2}}>0$. The winds used are denoted by blue circles. The estimated departure point $\tilde{x}_{i+\frac{1}{2}}^n$ is illustrated by a red circle. \label{dp1-fig}}}
\end{figure}
