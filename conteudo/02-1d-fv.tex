...
\begin{prob}
	...
	\textcolor{red}{Assume the framework of Problem \ref{chp-adv1d-sec2-prob2}
...
Finally, for both the unlimited PPM (hord0) and limited PPM (hord8) schemes, $F_{i+\frac{1}{2}}^n$ uses the stencil
