...
%departure point     
\node[bullet=orange,label={[above]:$\tilde{u}_{i+\frac{1}{2}}^n$}, minimum size=0.25cm] at (4,2) {};
\draw[->,blue] (1.5,0) -- (6,4) node[red,right] {};
\node[rectangle,color=blue,fill] at (6,4) {};
\node[bullet=red,label={[above]:$\tilde{x}_{i+\frac{1}{2}}^n$}, minimum size=0.25cm] at (1.5,0) {};
\draw[<->] (1.5,-0.2) -- node[below] {$ \tilde{{u}}^{n}_{i+\frac{1}{2}}\Delta t $} (6,-0.2);
%corner points
